...
class DoctorController extends Controller
{
    ...
    //     // Mover la cita a la tabla historial_citas si el estado es completada o cancelada
    //     if (in_array($request->input('estado'), ['completada', 'cancelada'])) {
    //         // Mover la cita a historial_citas
    ...
    //             'motivo' => $request->input('estado') === 'cancelada' ? $dataToUpdate['motivo'] : null,
    //         ]);
    
    //         // Verificar si hay pagos asociados a la cita
    //         $pagos = DB::table('pagos')->where('idCita', $idCita)->get();
    //         if ($pagos->isNotEmpty()) {
    //             foreach ($pagos as $pago) {
    //                 // Mover cada pago a historial_pagos
    //                 DB::table('historial_pagos')->insert([
    //                     'idCita' => $pago->idCita,
    //                     'monto' => $pago->monto,
    //                     'estado' => $pago->estado,
    //                     'hora_generacion' => $pago->hora_generacion,
    ...
    //             DB::table('pagos')->where('idCita', $idCita)->delete();
    //         }
    ...
    //             ->delete();
    //     } else {
    //         // Actualizar el estado de la cita si no se mueve al historial
    //         DB::table('citas')
    //             ->where('idCita', $idCita)
    //             ->update($dataToUpdate);
    //     }
